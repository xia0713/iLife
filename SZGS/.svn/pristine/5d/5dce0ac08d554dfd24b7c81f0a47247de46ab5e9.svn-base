...
import com.szgs.bbs.ask.CommentResponse;
import com.szgs.bbs.common.util.LggsUtils;
import com.szgs.bbs.common.view.CircleImageView;

public class CommentsAdapter extends MyBaseAdapter<CommentResponse.Content> {

	private DisplayImageOptions options;

	public CommentsAdapter(Context context, List<CommentResponse.Content> list) {
		super(context, list);
	...
	public View getConvertView(int position, View convertView,
		...
		CommentResponse.Content content = getItem(position);
