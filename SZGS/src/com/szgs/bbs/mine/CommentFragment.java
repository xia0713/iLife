...
public class CommentFragment extends BaseFragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		initView();
		contentlist = new ArrayList<CommentsMeResponse.ContentQestion>();
		initData();
		sendRequset();
		initListener();
		return view;
	...
	public void initData() {
		myAdapter = new CommentMeAdapter(getActivity(), contentlist);
	...
	public void sendRequset() {
		...
		String url = Constans.URL + "comments/of_answer_by";
		RequestParams params = new RequestParams();
		params.put("answerBy", CacheUtils.getUserId(getActivity()));
		...
		client.get(url, params, new JsonHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				Gson gson = new Gson();
				if (statusCode == 200) {
					CommentsMeResponse questionlistRep = gson.fromJson(
							response.toString(), CommentsMeResponse.class);
