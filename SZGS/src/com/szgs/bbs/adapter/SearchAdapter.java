...
public class SearchAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (tag.equals("我的提问")) {
			holder.img_homeitem_listedit.setVisibility(View.VISIBLE);
		...
		if (keyword != null) {
			holder.tv_homeitem_content.setText(LggsUtils.SetTextColor(mContext,
					myList.get(position).title, keyword));
		} else {
